	...
	void generate_leaders(){
		...
		for(map<int, string>::iterator it=instructions.begin();it!=instructions.end();it++){
			...
			if((ins[0]=='i' && ins[1]=='f')||(ins[0]=='g'&&ins[1]=='o'&&ins[2]=='t'&&ins[3]=='o')){
				...
				char num[val.length()+1];
				strcpy(num,val.c_str());
				int x=atoi(num);
		...
		cout<<"leaders "<<endl;
		for(int i=0;i<leaderLineNo.size();i++){
			cout<<leaderLineNo[i].second<<endl;
		}
		cout<<endl;
		cout<<"blocks\tinstructions"<<endl;
		for(int i=0;i<leaderLineNo.size()-1;i++){
			cout<<leaderLineNo[i].first<<endl;
			for(int j=leaderLineNo[i].second;j<leaderLineNo[i+1].second;j++){
				cout<<"\t"<<instructions[j]<<endl;
			}
		}
...
#line 315 "flow.tab.c" /* yacc.c:339  */
...
union YYSTYPE
{
#line 251 "flow.y" /* yacc.c:355  */

	char * str;
	struct Node * nn;
	struct NodeDec * nd;

#line 394 "flow.tab.c" /* yacc.c:355  */
};
...
#line 411 "flow.tab.c" /* yacc.c:358  */
...
{
       0,   265,   265,   274,   274,   280,   281,   282,   283,   284,
     286,   291,   294,   296,   302,   310,   320,   320,   322,   330,
     338,   346,   355,   356,   358,   365,   367,   368,   374,   387,
     403,   405,   406,   407,   408,   410,   411,   412,   413,   415,
     416,   420,   423,   424,   426,   428,   430,   436,   442,   447,
     452,   459,   460,   462,   463,   464,   465,   466,   467
};
#endif
...
#line 1568 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 3:
#line 274 "flow.y" /* yacc.c:1646  */
    {block++;}
#line 1574 "flow.tab.c" /* yacc.c:1646  */
    break;
...
#line 1585 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 280 "flow.y" /* yacc.c:1646  */
    {type="";(yyval.nn)=new node();(yyval.nn)->nextList=(yyvsp[0].nn)->nextList;}
#line 1591 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 281 "flow.y" /* yacc.c:1646  */
    {(yyval.nn)=new node();(yyval.nn)->nextList=(yyvsp[0].nn)->nextList;}
#line 1597 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 282 "flow.y" /* yacc.c:1646  */
    {(yyval.nn)=new node();(yyval.nn)->nextList=(yyvsp[0].nn)->nextList;}
#line 1603 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 283 "flow.y" /* yacc.c:1646  */
    {(yyval.nn)=new node();(yyval.nn)->nextList=(yyvsp[0].nn)->nextList;}
#line 1609 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 284 "flow.y" /* yacc.c:1646  */
    {(yyval.nn)=new node();(yyval.nn)->nextList=(yyvsp[0].nn)->nextList;}
#line 1615 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 10:
#line 286 "flow.y" /* yacc.c:1646  */
    {
			(yyval.nn)=new node();
			bp((yyvsp[-2].nn)->nextList,(yyvsp[-1].nn)->ins);
			(yyval.nn)->nextList=(yyvsp[0].nn)->nextList;
		}
#line 1625 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 11:
#line 291 "flow.y" /* yacc.c:1646  */
    {
			(yyval.nn)->nextList=(yyvsp[0].nn)->nextList;
		}
#line 1633 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 294 "flow.y" /* yacc.c:1646  */
    {}
#line 1639 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 296 "flow.y" /* yacc.c:1646  */
    {
		(yyval.nn)=new node();
		bp((yyvsp[-3].nn)->trueList,(yyvsp[-1].nn)->ins);
		(yyval.nn)->nextList=mergeVectors((yyvsp[-3].nn)->falseList,(yyvsp[0].nn)->nextList);
	}
#line 1649 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 302 "flow.y" /* yacc.c:1646  */
    {
				(yyval.nn)=new node();
...
#line 1661 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 15:
#line 310 "flow.y" /* yacc.c:1646  */
    {
				(yyval.nn)=new node();
				bp((yyvsp[-3].nn)->trueList,(yyvsp[-1].nn)->ins);
...
#line 1675 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 16:
#line 320 "flow.y" /* yacc.c:1646  */
    {type=(yyvsp[0].str);}
#line 1681 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 17:
#line 320 "flow.y" /* yacc.c:1646  */
    {(yyval.nn)=makeNode();}
#line 1687 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 18:
#line 322 "flow.y" /* yacc.c:1646  */
    {
					checkId((yyvsp[-3].str));
...
#line 1700 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 19:
#line 330 "flow.y" /* yacc.c:1646  */
    {
					checkId((yyvsp[-5].str));
					(yyval.nd) = makeNodeDec();
					(yyval.nd)->type = type;
...
#line 1713 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 20:
#line 338 "flow.y" /* yacc.c:1646  */
    {
					checkId((yyvsp[-2].str));
					(yyval.nd) = makeNodeDec();
					(yyval.nd)->type = type;
...
#line 1726 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 21:
#line 346 "flow.y" /* yacc.c:1646  */
    {
					checkId((yyvsp[-4].str));
					(yyval.nd) = makeNodeDec();
					(yyval.nd)->type = type;
...
#line 1739 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 22:
#line 355 "flow.y" /* yacc.c:1646  */
    {(yyval.str)=(yyvsp[0].str);}
#line 1745 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 23:
#line 356 "flow.y" /* yacc.c:1646  */
    {(yyval.str)=(yyvsp[0].str);}
#line 1751 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 24:
#line 358 "flow.y" /* yacc.c:1646  */
    {
				(yyval.nd)=makeNodeDec();
...
#line 1763 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 25:
#line 365 "flow.y" /* yacc.c:1646  */
    {(yyval.nd)=makeNodeDec();}
#line 1769 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 26:
#line 367 "flow.y" /* yacc.c:1646  */
    {instructions[getIns()]=(yyvsp[-3].nn)->name+"["+(yyvsp[-3].nn)->code+"]= "+(yyvsp[-1].nn)->code;}
#line 1775 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 27:
#line 368 "flow.y" /* yacc.c:1646  */
    {
			checkDeclared((yyvsp[-3].str));
			instructions[getIns()]=(string)(yyvsp[-3].str)+" = "+(yyvsp[-1].nn)->code;
	  		(yyval.nn)=new Node();
		}
#line 1785 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 28:
#line 374 "flow.y" /* yacc.c:1646  */
    {
			(yyval.nn)=makeNode();
...
#line 1803 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 29:
#line 387 "flow.y" /* yacc.c:1646  */
    {
...
#line 1823 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 30:
#line 403 "flow.y" /* yacc.c:1646  */
    {(yyval.nn)=(yyvsp[0].nn);}
#line 1829 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 31:
#line 405 "flow.y" /* yacc.c:1646  */
    {(yyval.nn)=makeNode();instructions[getIns()]=(yyval.nn)->code+" = "+(yyvsp[0].nn)->name+"["+(yyvsp[0].nn)->code+"]";}
#line 1835 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 32:
#line 406 "flow.y" /* yacc.c:1646  */
    {(yyval.nn)=makeNode();instructions[getIns()]=(yyval.nn)->code+" = "+(yyvsp[-2].nn)->code+" + "+(yyvsp[0].nn)->code;}
#line 1841 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 33:
#line 407 "flow.y" /* yacc.c:1646  */
    {(yyval.nn)=makeNode();instructions[getIns()]=(yyval.nn)->code+" = "+(yyvsp[-2].nn)->code+" - "+(yyvsp[0].nn)->code;}
#line 1847 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 34:
#line 408 "flow.y" /* yacc.c:1646  */
    {(yyval.nn)=(yyvsp[0].nn);}
#line 1853 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 35:
#line 410 "flow.y" /* yacc.c:1646  */
    {(yyval.nn)=makeNode();instructions[getIns()]=(yyval.nn)->code+" = "+(yyvsp[0].nn)->name+"["+(yyvsp[0].nn)->code+"]";}
#line 1859 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 36:
#line 411 "flow.y" /* yacc.c:1646  */
    {(yyval.nn)=makeNode();instructions[getIns()]=(yyval.nn)->code+" = "+(yyvsp[-2].nn)->code+" * "+(yyvsp[0].nn)->code;}
#line 1865 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 37:
#line 412 "flow.y" /* yacc.c:1646  */
    {(yyval.nn)=makeNode();instructions[getIns()]=(yyval.nn)->code+" = "+(yyvsp[-2].nn)->code+" / "+(yyvsp[0].nn)->code;}
#line 1871 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 38:
#line 413 "flow.y" /* yacc.c:1646  */
    {(yyval.nn)=(yyvsp[0].nn);}
#line 1877 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 39:
#line 415 "flow.y" /* yacc.c:1646  */
    {(yyval.nn)=makeNode();instructions[getIns()]=(yyval.nn)->code+" = "+(yyvsp[0].nn)->name+"["+(yyvsp[0].nn)->code+"]";}
#line 1883 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 40:
#line 416 "flow.y" /* yacc.c:1646  */
    {
			checkDeclared((yyvsp[0].str));
			(yyval.nn)=makeNode2((yyvsp[0].str));
		}
#line 1892 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 41:
#line 420 "flow.y" /* yacc.c:1646  */
    {
			(yyval.nn)=makeNode2((yyvsp[0].str));
		}
#line 1900 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 42:
#line 423 "flow.y" /* yacc.c:1646  */
    {(yyval.nn)=(yyvsp[-1].nn);}
#line 1906 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 43:
#line 424 "flow.y" /* yacc.c:1646  */
    {(yyval.nn)=makeNode();instructions[getIns()]=(yyval.nn)->code+" = - "+(yyvsp[0].nn)->code;}
#line 1912 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 44:
#line 426 "flow.y" /* yacc.c:1646  */
    {(yyval.nn)=new node();(yyval.nn)->ins=ins;}
#line 1918 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 45:
#line 428 "flow.y" /* yacc.c:1646  */
    {(yyval.nn)=new node();(yyval.nn)->nextList.push_back(getIns());instructions[(yyval.nn)->nextList.back()]="goto ";}
#line 1924 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 46:
#line 430 "flow.y" /* yacc.c:1646  */
    {
					(yyval.nn)=new node();
...
#line 1935 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 47:
#line 436 "flow.y" /* yacc.c:1646  */
    {
					(yyval.nn)=new node();
	 				bp((yyvsp[-3].nn)->trueList,(yyvsp[-1].nn)->ins);
...
#line 1946 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 48:
#line 442 "flow.y" /* yacc.c:1646  */
    {
					(yyval.nn)=new node();
					(yyval.nn)->trueList=(yyvsp[0].nn)->falseList;
					(yyval.nn)->falseList=(yyvsp[0].nn)->trueList;
				}
#line 1956 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 49:
#line 447 "flow.y" /* yacc.c:1646  */
    {
					(yyval.nn)=new node();
					(yyval.nn)->trueList=(yyvsp[-1].nn)->trueList;
					(yyval.nn)->falseList=(yyvsp[-1].nn)->falseList;
				}
#line 1966 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 50:
#line 452 "flow.y" /* yacc.c:1646  */
    {
					(yyval.nn)=new node();
...
#line 1978 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 51:
#line 459 "flow.y" /* yacc.c:1646  */
    {(yyval.nn)=new node();(yyval.nn)->trueList.push_back(getIns());instructions[(yyval.nn)->trueList.back()]="goto ";}
#line 1984 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 52:
#line 460 "flow.y" /* yacc.c:1646  */
    {(yyval.nn)=new node();(yyval.nn)->falseList.push_back(getIns());instructions[(yyval.nn)->falseList.back()]="goto ";}
#line 1990 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 53:
#line 462 "flow.y" /* yacc.c:1646  */
    {(yyval.str)=(yyvsp[0].str);}
#line 1996 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 54:
#line 463 "flow.y" /* yacc.c:1646  */
    {(yyval.str)=(yyvsp[0].str);}
#line 2002 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 55:
#line 464 "flow.y" /* yacc.c:1646  */
    {(yyval.str)=(yyvsp[0].str);}
#line 2008 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 56:
#line 465 "flow.y" /* yacc.c:1646  */
    {(yyval.str)=(yyvsp[0].str);}
#line 2014 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 57:
#line 466 "flow.y" /* yacc.c:1646  */
    {(yyval.str)=(yyvsp[0].str);}
#line 2020 "flow.tab.c" /* yacc.c:1646  */
    break;

  case 58:
#line 467 "flow.y" /* yacc.c:1646  */
    {(yyval.str)=(yyvsp[0].str);}
#line 2026 "flow.tab.c" /* yacc.c:1646  */
    break;


#line 2030 "flow.tab.c" /* yacc.c:1646  */
      default: break;
    }
